 ...
 *
 * This class is responisble for validating that a value is a correctly formatted
 * email.
 */
class Email extends Validation
{
    ...
    {
        return preg_match(self::EMAIL_REGEX, $this->value);
    }
    ...
    {
        return "The $this->name field must be a valid email.";
    }
}
